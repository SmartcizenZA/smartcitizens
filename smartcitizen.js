...
server.listen(port, function() {
  ...
  mailer.sendMailToCity("ishmael.makitla@gmail.com, mtswenij@gmail","Meter Readings", "Please find the attached meter readings from my house", function (successful){
   console.log("The Email was send successfully? "+successful);
  }, "20141206_ERF33033");
});
